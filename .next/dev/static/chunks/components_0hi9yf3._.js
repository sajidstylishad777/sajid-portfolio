...
var e = new Error("Could not parse module '[project]/components/Hero.tsx'\n\nUnexpected token. Did you mean `{'>'}` or `&gt;`?");
...
function ProjectCard({ project, index }) {
    _s();
    const [open, setOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [fullscreenIndex, setFullscreenIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectCard.useEffect": ()=>{
            if (!open) return;
            const onKey = {
                "ProjectCard.useEffect.onKey": (e)=>{
                    if (e.key === "Escape") {
                        if (fullscreenIndex !== null) setFullscreenIndex(null);
                        else setOpen(false);
                    }
                    if (fullscreenIndex !== null) {
                        if (e.key === "ArrowRight") setFullscreenIndex({
                            "ProjectCard.useEffect.onKey": (i)=>i === null ? i : (i + 1) % images.length
                        }["ProjectCard.useEffect.onKey"]);
                        if (e.key === "ArrowLeft") setFullscreenIndex({
                            "ProjectCard.useEffect.onKey": (i)=>i === null ? i : (i - 1 + images.length) % images.length
                        }["ProjectCard.useEffect.onKey"]);
                    }
                }
            }["ProjectCard.useEffect.onKey"];
...
_s(ProjectCard, "5dxQ0s0OHLNWpV6gUfj8PVDv3pM=");
_c = ProjectCard;
var _c;
...
//# sourceMappingURL=components_0hi9yf3._.js.map